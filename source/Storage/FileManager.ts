...
export default class FileManager {
     ...
     */
    public async CreateDirectory(path: string): Promise<SuccessInterface | ErrorInterface> {
        try {
     ...
     */
    public async DeleteDirectory(path: string): Promise<SuccessInterface | ErrorInterface> {
        try {
     ...
     */
    public async DirectoryExists(path: string): Promise<SuccessInterface | ErrorInterface> {
        try {
            const ExistsResponse = await this.fileSystem.access(path);
            return this.responseHelper.Success(ExistsResponse);
        } catch (error) {
     ...
     */
    public async CreateReadStream(path: string): Promise<ErrorInterface | FileSystemSync.ReadStream>{
        try {
     ...
     */
    public async CreateWriteStream(path: string): Promise<ErrorInterface | FileSystemSync.WriteStream>{
        try {
