  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await apiClient.delete(
        `/api/operation/delete/by-id/?dbName=${encodeURIComponent(databaseName)}&collectionName=${encodeURIComponent(collectionName)}&documentId=${encodeURIComponent(documentId)}`
      )
