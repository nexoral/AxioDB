...
const Changelog: React.FC = () => {
  return (
    <div className="space-y-12">
      ...
      />
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-violet-900/20 via-slate-800 to-indigo-900/20 rounded-2xl p-8 lg:p-12 border border-violet-700 shadow-xl">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-5xl lg:text-6xl font-extrabold mb-6 bg-gradient-to-r from-violet-400 via-indigo-400 to-blue-400 bg-clip-text text-transparent">
            Changelog
          </h1>
