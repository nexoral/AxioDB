    ...
    <section id="security" className="pt-12 scroll-mt-20">
      ...
      <div className="bg-gray-100 rounded-lg p-8 shadow-lg border border-green-200 mb-8 animate-fade-in-up">
        ...
        <p className="text-gray-600 mb-4">
          The Control Server (the built-in web GUI at <code className="bg-white px-1 py-0.5 rounded">localhost:27018</code>) ships
          with login and role-based access control. On first start it seeds a reserved{" "}
          <code className="bg-white px-1 py-0.5 rounded">config</code> database (hidden from the regular
          database list and unreachable through the generic database/collection/document routes) holding three collections -{" "}
          <code className="bg-white px-1 py-0.5 rounded">users</code>,{" "}
          <code className="bg-white px-1 py-0.5 rounded">roles</code>, and{" "}
          <code className="bg-white px-1 py-0.5 rounded">permissions</code> - plus a default{" "}
          <code className="bg-white px-1 py-0.5 rounded">admin</code>/<code className="bg-white px-1 py-0.5 rounded">admin</code> account.
        </p>
        <ul className="space-y-2 list-disc pl-6 text-gray-600 mb-4">
          <li>
            <strong>Password hashing:</strong> Node&apos;s built-in <code className="bg-white px-1 py-0.5 rounded">crypto.scrypt</code>{" "}
        ...
        <div className="bg-accent-100/20 border-l-4 border-accent-500 p-4 rounded-r-lg mb-4">
          <p className="text-gray-600 text-sm">
            <strong>This isn&apos;t GUI-only:</strong> AxioDBCloud&apos;s TCP server reuses this exact same{" "}
            <code className="bg-white px-1 py-0.5 rounded">config</code> database, accounts, and
            roles when started with <code className="bg-white px-1 py-0.5 rounded">TCPAuth: true</code> —
        ...
        <div className="bg-yellow-100/20 border-l-4 border-yellow-500 p-4 rounded-r-lg flex items-start gap-2">
      ...
      <div className="bg-yellow-100/20 border-l-4 border-yellow-500 p-4 rounded-r-lg mb-8">
