    ...
    <div className="space-y-12">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-900/20 via-slate-800 to-indigo-900/20 rounded-2xl p-8 lg:p-12 border border-blue-700 shadow-xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-2xl lg:text-3xl text-slate-200 font-medium mb-4">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-green-900/20 to-emerald-900/20 p-6 rounded-xl border border-green-700">
            ...
            <p className="text-slate-300">
              Use the exact same API as embedded AxioDB. Just change from <code className="px-2 py-1 bg-slate-800 rounded">new AxioDB()</code> to <code className="px-2 py-1 bg-slate-800 rounded">new AxioDBCloud()</code>
            </p>
          </div>

          <div className="bg-gradient-to-br from-blue-900/20 to-cyan-900/20 p-6 rounded-xl border border-blue-700">
            <div className="flex items-center gap-3 mb-4">
          ...
          <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 p-6 rounded-xl border border-purple-700">
            <div className="flex items-center gap-3 mb-4">
          ...
          <div className="bg-gradient-to-br from-orange-900/20 to-red-900/20 p-6 rounded-xl border border-orange-700">
            <div className="flex items-center gap-3 mb-4">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
            ...
            <p className="text-slate-300 mb-4">
              ...
              <code className="px-1.5 py-0.5 mx-1 bg-slate-900 rounded">docker run</code>
          ...
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
            ...
            <p className="text-slate-300 mb-4">
              ...
              so it can be reached over TCP from another service (Service B) using the <code className="px-1.5 py-0.5 bg-slate-900 rounded">AxioDBCloud</code> client
...
console.log('AxioDB TCP Server running on port 27019');`}
            ...
            <div className="mt-4 p-4 bg-green-900/20 rounded-lg border border-green-700">
              <p className="text-sm text-green-200">
                <strong>Default Port:</strong> TCP server listens on port <code className="px-1 py-0.5 bg-slate-800 rounded">27019</code> (HTTP GUI uses 27018).
                Service B then connects with <code className="px-1 py-0.5 bg-slate-800 rounded">new AxioDBCloud("axiodb://service-a-host:27019")</code> — see{" "}
...
await client.disconnect();`}
  ...
  password: 'admin',
            ...
            <p className="mt-3 text-sm text-slate-400">
              ...
              (<code className="px-1 py-0.5 bg-slate-900 rounded">ulimit -n</code>,
              ...
              limit (e.g. <code className="px-1 py-0.5 bg-slate-900 rounded">ulimit -n 65536</code>,
              or <code className="px-1 py-0.5 bg-slate-900 rounded">docker run --ulimit nofile=65536:65536</code>)
            ...
            <p className="mt-3 text-sm text-slate-400">
              ...
              <code className="px-1 py-0.5 bg-slate-900 rounded">429</code>{" "}
            ...
            <p className="mt-3 text-sm text-slate-400">
              ...
              <code className="px-1 py-0.5 bg-slate-900 rounded">connect()</code>{" "}
              doesn&apos;t reject outright - it resolves as long as at least one pool member
              connected, and emits a <code className="px-1 py-0.5 bg-slate-900 rounded">poolDegraded</code>{" "}
...
await client.connect(); // resolves even if some pool members were rejected`}
            ...
            <p className="mt-3 text-sm text-slate-400">
              ...
              with a <code className="px-1 py-0.5 bg-slate-900 rounded">429</code>{" "}
      ...
      <section>
        ...
        <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 space-y-6">
          <p className="text-slate-300">
            ...
            <code className="px-2 py-1 bg-slate-900 rounded">TCPAuth: true</code> to require a
          ...
          <div>
            <h3 className="text-xl font-bold mb-3 text-white">Server</h3>
            <CodeBlock
              language="javascript"
  ...
  CustomPath: './data',
          ...
          <div>
            <h3 className="text-xl font-bold mb-3 text-white">Client</h3>
            <CodeBlock
              language="javascript"
...
await client2.login('admin', 'admin');`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-emerald-900/20 rounded-lg border border-emerald-700">
              <h4 className="font-bold text-emerald-200 mb-2">What&apos;s enforced</h4>
              <ul className="text-sm text-emerald-300 space-y-1.5">
            ...
            <div className="p-4 bg-amber-900/20 rounded-lg border border-amber-700">
              ...
              <ul className="text-sm text-amber-300 space-y-1.5">
      ...
      <section>
        ...
        <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 space-y-6">
          <p className="text-slate-300">
            ...
            read your data and, if <code className="px-2 py-1 bg-slate-900 rounded">TCPAuth</code>{" "}
          ...
          <div>
            ...
            />
            <p className="mt-3 text-sm text-slate-400">
              This creates two files, <code className="px-1 py-0.5 bg-slate-900 rounded">cert.pem</code>{" "}
              and <code className="px-1 py-0.5 bg-slate-900 rounded">key.pem</code>, in your current
  ...
  TLSKeyPath: './key.pem',
          ...
          <div>
            ...
            <p className="text-slate-300 mb-3">
              ...
              need this step, the same way your browser trusts <code className="px-1 py-0.5 bg-slate-900 rounded">https://</code> sites
              without extra setup:
            </p>
            <CodeBlock
              language="javascript"
...
await client.connect();`}
            ...
            <p className="mt-3 text-sm text-slate-400">
              ...
              server by default (<code className="px-1 py-0.5 bg-slate-900 rounded">tlsRejectUnauthorized</code>{" "}
              defaults to <strong>true</strong>) - this is intentional, the same protection that
              stops a browser from silently trusting a fake <code className="px-1 py-0.5 bg-slate-900 rounded">https://</code> site.
          ...
          <div className="p-4 bg-sky-900/20 rounded-lg border border-sky-700">
            <h4 className="font-bold text-sky-200 mb-2">Running this in Docker?</h4>
            <p className="text-sm text-sky-300 mb-3">
              ...
              <strong>bind mount</strong> (<code className="px-1 py-0.5 bg-slate-900 rounded">-v</code>)
...
docker run -d --name axiodb-server \\
  ...
  theankansaha/axiodb`}
            ...
            <p className="mt-3 text-sm text-sky-300">
              The rule: the <code className="px-1 py-0.5 bg-slate-900 rounded">AXIODB_TLS_CERT_PATH</code>{" "}
              value must always match the <em>right-hand side</em> of the{" "}
              <code className="px-1 py-0.5 bg-slate-900 rounded">-v</code> mount
              (<code className="px-1 py-0.5 bg-slate-900 rounded">/certs/...</code>),
...
const stats = await users.aggregate([
  ...
  { $group: { _id: null, avgAge: { $avg: "$age" } } }
          ...
          {/* Real-world Example */}
          <div className="bg-gradient-to-br from-indigo-900/20 to-purple-900/20 p-6 rounded-xl border border-indigo-700">
            <h3 className="text-xl font-bold mb-4 text-white">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={idx}
              className={`bg-gradient-to-br from-${useCase.color}-900/20 to-${useCase.color}-800/20 p-6 rounded-xl border border-${useCase.color}-700`}
            >
