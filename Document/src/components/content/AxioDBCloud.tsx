    ...
    <div className="space-y-12">
      ...
      <section className="relative overflow-hidden bg-gray-100 rounded-lg p-5 sm:p-8 lg:p-12 border border-accent-200 shadow-md">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent-50 rounded-full border border-accent-600 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-green-50 p-6 rounded-xl border border-green-200">
            ...
            <p className="text-gray-600">
              Use the exact same API as embedded AxioDB. Just change from <code className="px-2 py-1 bg-gray-100 rounded">new AxioDB()</code> to <code className="px-2 py-1 bg-gray-100 rounded">new AxioDBCloud()</code>
            </p>
          </div>
      ...
      <section>
        <h2 className="text-3xl font-bold mb-6 text-gray-900 flex items-center gap-3">
          <Server className="h-8 w-8 text-accent-600" />
          Server Setup
        </h2>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              ...
              <code className="px-1.5 py-0.5 mx-1 bg-white rounded">docker run</code>
              quick start, then advanced env vars, volumes, and Compose — live on the dedicated Docker page:
            </p>

            <a
              href="/docker"
              className="inline-flex items-center gap-2 px-5 py-3 bg-accent-600 text-white rounded-lg font-semibold hover:bg-accent-700 transition-colors"
            >
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              ...
              so it can be reached over TCP from another service (Service B) using the <code className="px-1.5 py-0.5 bg-white rounded">AxioDBCloud</code> client
...
console.log('AxioDB TCP Server running on port 27019');`}
            ...
            <div className="mt-4 p-4 bg-green-100/20 rounded-lg border border-green-200">
              <p className="text-sm text-green-700">
                <strong>Default Port:</strong> TCP server listens on port <code className="px-1 py-0.5 bg-gray-100 rounded">27019</code> (HTTP GUI uses 27018).
                Service B then connects with <code className="px-1 py-0.5 bg-gray-100 rounded">new AxioDBCloud("axiodb://service-a-host:27019")</code> — see{" "}
...
await client.disconnect();`}
          ...
          <div className="p-4 bg-purple-100/20 rounded-lg border border-purple-200">
  ...
  password: 'admin',
            ...
            <p className="mt-3 text-sm text-gray-600">
              ...
              (<code className="px-1 py-0.5 bg-white rounded">ulimit -n</code>,
              ...
              limit (e.g. <code className="px-1 py-0.5 bg-white rounded">ulimit -n 65536</code>,
              or <code className="px-1 py-0.5 bg-white rounded">docker run --ulimit nofile=65536:65536</code>)
            ...
            <p className="mt-3 text-sm text-gray-600">
              ...
              <code className="px-1 py-0.5 bg-white rounded">429</code>{" "}
            ...
            <p className="mt-3 text-sm text-gray-600">
              ...
              <code className="px-1 py-0.5 bg-white rounded">connect()</code>{" "}
              doesn&apos;t reject outright - it resolves as long as at least one pool member
              connected, and emits a <code className="px-1 py-0.5 bg-white rounded">poolDegraded</code>{" "}
...
await client.connect(); // resolves even if some pool members were rejected`}
            ...
            <p className="mt-3 text-sm text-gray-600">
              ...
              with a <code className="px-1 py-0.5 bg-white rounded">429</code>{" "}
      ...
      <section>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 space-y-6">
          ...
          <div>
            <h3 className="text-xl font-bold mb-3 text-gray-900">Server</h3>
            <CodeBlock
              language="javascript"
  ...
  CustomPath: './data',
          ...
          <div>
            <h3 className="text-xl font-bold mb-3 text-gray-900">Client</h3>
            <CodeBlock
              language="javascript"
...
await client2.login('admin', 'admin');`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-emerald-100/20 rounded-lg border border-emerald-200">
              <h4 className="font-bold text-emerald-700 mb-2">What&apos;s enforced</h4>
            ...
            <div className="p-4 bg-amber-100/20 rounded-lg border border-amber-200">
      ...
      <section>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 space-y-6">
          <p className="text-gray-600">
            ...
            read your data and, if <code className="px-2 py-1 bg-white rounded">TCPAuth</code>{" "}
          ...
          <div>
            ...
            />
            <p className="mt-3 text-sm text-gray-600">
              This creates two files, <code className="px-1 py-0.5 bg-white rounded">cert.pem</code>{" "}
              and <code className="px-1 py-0.5 bg-white rounded">key.pem</code>, in your current
  ...
  TLSKeyPath: './key.pem',
          ...
          <div>
            ...
            <p className="text-gray-600 mb-3">
              ...
              need this step, the same way your browser trusts <code className="px-1 py-0.5 bg-white rounded">https://</code> sites
              without extra setup:
            </p>
            <CodeBlock
              language="javascript"
...
await client.connect();`}
            ...
            <p className="mt-3 text-sm text-gray-600">
              ...
              server by default (<code className="px-1 py-0.5 bg-white rounded">tlsRejectUnauthorized</code>{" "}
              defaults to <strong>true</strong>) - this is intentional, the same protection that
              stops a browser from silently trusting a fake <code className="px-1 py-0.5 bg-white rounded">https://</code> site.
          ...
          <div className="p-4 bg-sky-100/20 rounded-lg border border-sky-200">
            <h4 className="font-bold text-sky-700 mb-2">Running this in Docker?</h4>
            <p className="text-sm text-sky-700 mb-3">
              ...
              <strong>bind mount</strong> (<code className="px-1 py-0.5 bg-white rounded">-v</code>)
...
docker run -d --name axiodb-server \\
  ...
  theankansaha/axiodb`}
            ...
            <p className="mt-3 text-sm text-sky-700">
              The rule: the <code className="px-1 py-0.5 bg-white rounded">AXIODB_TLS_CERT_PATH</code>{" "}
              value must always match the <em>right-hand side</em> of the{" "}
              <code className="px-1 py-0.5 bg-white rounded">-v</code> mount
              (<code className="px-1 py-0.5 bg-white rounded">/certs/...</code>),
...
main().catch(console.error);`}
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            { icon: CheckCircle, title: "30 Commands", desc: "Full CRUD, aggregation, indexing, and transactions" },
            ...
            <div
              key={idx}
              className="flex items-start gap-4 p-4 bg-gray-100 rounded-lg border border-gray-200"
            >
              <div className="p-2 bg-accent-100/30 rounded-lg">
      ...
      <section className="bg-accent-600 text-white p-8 rounded-xl">
        ...
        <div className="flex flex-wrap gap-4">
          <a
            href="/installation"
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-accent-600 rounded-lg font-semibold hover:bg-accent-50 transition-colors"
          >
            Installation Guide
          ...
          <a
            href="/api-reference"
            className="inline-flex items-center gap-2 px-6 py-3 border-2 border-white text-gray-900 rounded-lg font-semibold hover:bg-white/10 transition-colors"
          >
            API Reference
