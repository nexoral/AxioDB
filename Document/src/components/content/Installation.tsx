...
const Installation: React.FC = () => {
  ...
  return (
    <section id="installation" className="pt-12 scroll-mt-20">
      ...
      <div className="group relative bg-slate-800 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 p-8 lg:p-10 mb-12 border border-slate-700 hover:border-blue-600">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/5 to-indigo-900/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
          ...
          <div className="bg-gradient-to-r from-blue-900/20 to-indigo-900/20 p-6 rounded-xl border border-blue-700">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-blue-200 leading-relaxed">
                  ...
                  <code className="bg-slate-800 px-2 py-1 rounded-md text-xs font-mono border border-blue-800">
                    node --version
                  </code>{" "}
                  before installation.
                </p>
      ...
      {/* System Requirements */}
      <div className="group relative bg-slate-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 lg:p-10 mb-12 border border-slate-700">
        <div className="absolute inset-0 bg-gradient-to-br from-green-900/10 to-emerald-900/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-slate-700 to-slate-800 p-6 rounded-xl border border-slate-600 shadow-sm hover:shadow-md transition-shadow">
      ...
      {/* Ready to Use Banner */}
      <div className="relative overflow-hidden bg-gradient-to-r from-green-900/20 via-emerald-900/20 to-teal-900/20 rounded-2xl p-8 lg:p-10 border-l-4 border-green-500 shadow-xl">
        ...
        <div className="relative z-10 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h4 className="text-2xl font-bold text-green-100 mb-3">
