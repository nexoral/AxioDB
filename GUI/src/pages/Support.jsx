            ...
            <div className='flex items-center space-x-6'>
              ...
              <div>
                ...
                <p className='text-blue-100 text-lg'>
                  {authorInfo?.AuthorDetails?.Designation ||
                    'Software Engineer'}
                </p>
                <p className='text-blue-100'>
                  {authorInfo?.AuthorDetails?.Country || 'India'} • Solo
                  Developer
                </p>
              </div>
            </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className='text-gray-600'>
                        {authorInfo?.AuthorDetails?.Email}
                      </p>
                    </div>
                  </a>
          ...
          <div className='flex items-start'>
            ...
            <div className='ml-4'>
              ...
              <div className='prose text-yellow-800'>
                <p className='mb-4'>
                  If you encounter any issues with AxioDB, please help me
                  resolve them quickly by providing detailed information:
                </p>
                <ul className='list-disc list-inside space-y-2 mb-4'>
                  <li>
                    <strong>Detailed Description:</strong> What exactly happened
                    and what did you expect?
                  </li>
                  <li>
                    <strong>Steps to Reproduce:</strong> Please provide
                    step-by-step instructions to reproduce the error
                  </li>
                  <li>
                    <strong>Environment:</strong> Operating system, Node.js
                    version, AxioDB version
                  </li>
                  <li>
                    <strong>Error Messages:</strong> Copy the complete error
                    message and stack trace
                  </li>
                  <li>
                    <strong>Code Sample:</strong> Minimal code that reproduces
                    the issue
                  </li>
                </ul>
                <div className='bg-yellow-100 rounded-lg p-4 mt-4'>
                  ...
                  <p className='text-yellow-800 mt-1'>
                    As a solo developer, I appreciate your patience. I'll
                    respond to issues as soon as possible and work diligently to
                    resolve them. Your detailed bug reports help me fix issues
                    faster!
                  </p>
                </div>
              </div>
          ...
          <div className='flex items-center'>
            ...
            <div>
              ...
              <p className='text-blue-700 mt-1'>
                I typically respond within 24-48 hours. For critical issues,
                I'll prioritize and respond as soon as possible.
              </p>
            </div>
          </div>
        </div>
