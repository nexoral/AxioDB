      ...
      >
        ...
        <div className='text-center mb-8'>
          <motion.div
            ...
            className='w-16 h-16 bg-info-50 rounded-full flex items-center justify-center mx-auto mb-4'
          >
            <svg
          ...
          <p className='text-ink-600'>
            Upload a ZIP or TAR file containing your exported database
          </p>
        </div>
              ...
              {!file
                ? (
                  ...
                  >
                    ...
                    >
                      <svg
                        className='w-12 h-12 text-ink-400 mx-auto mb-4'
                        fill='none'
                        stroke='currentColor'
                        viewBox='0 0 24 24'
                      >
                    ...
                    <p className='text-ink-500 mb-4'>or</p>
                    <label
                      htmlFor='file-upload'
          ...
          {uploadStatus && (
            ...
            >
              <div className='flex items-center'>
                ...
                <p
                  className={`font-medium ${uploadStatus === 'success' ? 'text-brand-800' : 'text-red-800'}`}
                >
                  {uploadStatus === 'success'
        ...
        <motion.div
          ...
          className='mt-8 bg-ink-50 rounded-lg p-6'
        >
          <h3 className='font-medium text-ink-900 mb-3'>Import Guidelines</h3>
