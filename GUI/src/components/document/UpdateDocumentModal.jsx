...
const UpdateDocumentModal = ({ isOpen, onClose, onDocumentUpdated, document, databaseName, collectionName }) => {
            ...
            <div className="mb-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-xs text-gray-500 font-mono">ID: {document.documentId}</span>
                </div>
              </div>
              <textarea
                value={documentData}
              ...
              <p className="mt-2 text-xs text-gray-500">
                You cannot change the document's ID. The updatedAt field will be automatically updated.
              </p>
            </div>
